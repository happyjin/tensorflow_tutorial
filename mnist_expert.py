...
if __name__ == "__main__":
    ...
    # step 1.2: convolve x_image with the weight tensor, add the bias, apply ReLU funtion, and finally max pool
    ...
    # step 3: Densely Connected Layer (fully-connected layer)
    ...
    # step 4: Dropout to reduce overfitting
    keep_prob = tf.placeholder(tf.float32)
    h_fc1_drop = tf.nn.dropout(h_fc1, keep_prob)

    # step 5: Readout Layer, just like for the one layer softmax regression above.
